    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#05060ae9] to-[#202833] p-4">
      <div className="bg-[#202833]  p-8 rounded-xl shadow-xl w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-50 mb-2">Create Account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`text-white w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${
